 ...
 */
export async function createTimeLog(payload: CreateTimeLogRequest): Promise<TimeLogResponse> {
 ...
 */
export async function startTimer(payload: StartTimerRequest): Promise<TimerResponse> {
 ...
 */
export async function stopTimer(payload: StopTimerRequest): Promise<TimeLogResponse> {
