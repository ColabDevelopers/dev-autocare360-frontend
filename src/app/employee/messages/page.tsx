                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-0.5">
                        <p
                          className={`font-medium truncate ${conversation.unreadCount > 0 ? 'text-foreground' : 'text-foreground/90'}`}
                        >
                          {conversation.name}
                        </p>
                      ...
                      <p
                        className={`text-sm truncate ${conversation.unreadCount > 0 ? 'font-medium text-foreground' : 'text-muted-foreground'}`}
                      >
              ...
              <div className="h-full flex items-center justify-center p-8 bg-[url('/grid.svg')] bg-muted/5">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                    Select a customer conversation from the list to view and respond to their
                    messages
                  </p>
                </div>
              </div>
