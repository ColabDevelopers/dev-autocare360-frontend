...
export default function AddServiceModal({ onClose, onServiceAdded }: { onClose: () => void; onServiceAdded: () => void }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2 bg-[#111] border border-[#2a2a2a] rounded-lg text-white"
            >
              <option value="active" className="bg-[#222] text-white">Active</option>
              <option value="inactive" className="bg-[#222] text-white">Inactive</option>
