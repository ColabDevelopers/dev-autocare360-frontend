                          ...
                          <div className="flex items-center space-x-4 mt-2 text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center space-x-1">
                              <span className="text-sm">
                                Technician: {appointment.technician || 'TBD'}
                              </span>
                            </div>
                          </div>
                        </div>
                  ...
                  {(() => {
                    ...
                    return days.map((date, index) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`text-xs font-medium mb-1 ${isSelected ? 'text-black' : ''}`}
                          >
                            {date.getDate()}
                          </div>
                            ...
                            <div className="space-y-0.5">
                              {dayAppointments.slice(0, 2).map(apt => {
                                ...
                                return (
                                  <div
                                    key={apt.id}
                                    className={`text-[7px] leading-tight rounded px-1 py-0.5 mb-0.5 ${
                                  ...
                                  >
                                    ...
                                    <div
                                      className={`text-[8px] truncate ${isSelected ? 'text-white/90' : 'text-muted-foreground'}`}
                                      title={apt.technician || 'TBD'}
                                    >
                                      {apt.technician
                              ...
                              {dayAppointments.length > 2 && (
                                <div
                                  className={`text-[6px] text-center rounded px-1 ${
